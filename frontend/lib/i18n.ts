...
const COPY = {
  ru: {
    ...
    home: {
      ...
      displayModeText: "Отдельные URL для общего экрана результатов и таблицы участников комнаты.",
    ...
    roomHub: {
      ...
      displayRoutesText: "Отдельные URL для проектора с результатами этапа и таблицей участников комнаты.",
  ...
  en: {
    ...
    roomHub: {
      ...
      displayRoutesText: "Projector-friendly URLs for stage results and player standings.",
