  ...
  ru: {
    ...
    pages: {
      room: {
        ...
        description:
          "Мобильная комната для голосования с двумя главными режимами: личный бюллетень и общий экран результатов.",
      },
      vote: {
      ...
      acts: {
        title: "Карточки артистов",
        kicker: "Внутри голосования",
        description:
          "Карточка артиста, заметки и видео открываются прямо из строки голосования.",
      },
      live: {
    ...
    home: {
      ...
      description:
        "Одна система голосования: личный бюллетень на телефоне и отдельные экраны для результатов и таблицы участников комнаты.",
      enterDefaultRoom: "Открыть основную комнату",
      openDisplayBoard: "Открыть экран результатов",
      fallbackWarning: "Комнаты временно недоступны, поэтому показана резервная комната.",
      ...
      displayModeText: "Отдельные ссылки для общего экрана результатов и таблицы участников комнаты.",
    ...
    roomHub: {
      ...
      description:
        "Телефоны остаются сфокусированными на заметках и точной расстановке мест. ТВ и проекторы получают общий экран результатов и таблицу участников.",
      ...
      displayRoutesTitle: "Экраны для просмотра",
      displayRoutesText: "Отдельные ссылки для общего экрана с результатами этапа и таблицей участников комнаты.",
      digitalNotesTitle: "Цифровые заметки",
      digitalNotesText: "Подход как у бумажного листа, но с сохранением по каждому артисту.",
      quickRoutes: "Быстрые переходы",
      ...
      actsGuideTitle: "Карточки артистов",
      actsGuideText: "Открываются прямо внутри голосования",
    ...
    live: {
      ...
      description:
        "Открой эту страницу на ТВ или проекторе. Опубликованные места артистов красиво собираются в общую таблицу комнаты.",
      revealed: "Опубликовано",
      display: "Экран",
      displayReady: "Готово для внешнего экрана",
      loadError: "Сейчас не удалось загрузить таблицу результатов этапа.",
      positionRevealed: "Позиция опубликована",
      waitingReveal: "Ждёт публикации",
    },
    players: {
      kicker: "Таблица комнаты",
      title: "Кто точнее всех угадывает итоговую таблицу",
      description:
        "Это отдельный экран результатов для телефонов, ноутбуков и проекторов. Он использует тот же язык движения, что и общий экран результатов этапа.",
      playersLabel: "Игроки",
      leaderLabel: "Лидер",
      liveLabel: "Эфир",
  ...
  en: {
    ...
    pages: {
      room: {
        ...
        kicker: "Евровидение у Морозовых 2026",
        description:
          "A mobile-first Eurovision room with two main modes: the personal ballot and the shared results screen.",
      },
      vote: {
        title: "Vote Studio",
      ...
      acts: {
        title: "Artist cards",
        kicker: "Inside voting",
        description:
          "Artist details, notes, and video open directly from the voting row.",
      },
      live: {
        title: "Live Results",
    ...
    home: {
      ...
      description:
        "One voting system: a personal mobile ballot plus dedicated screens for results and player standings.",
      enterDefaultRoom: "Enter default room",
      openDisplayBoard: "Open display board",
      fallbackWarning: "Rooms are temporarily unavailable, so a backup room is shown.",
      ...
      displayModeText: "Separate URLs for the shared results screen and the room leaderboard.",
    ...
    roomHub: {
      ...
      description:
        "Phones stay focused on notes and exact ranking. TVs and projectors get the shared results screen and the player standings.",
      ...
      displayRoutesTitle: "Shared screens",
      displayRoutesText: "Separate links for the shared results screen and player standings.",
      digitalNotesTitle: "Digital notes",
      digitalNotesText: "A paper-sheet mindset, now saved per performer.",
      quickRoutes: "Quick links",
      quickRoutesTitle: "Shareable room screens",
      voteStudioTitle: "Vote studio",
      voteStudioText: "Phone-first ranking and notes",
      actsGuideTitle: "Artist cards",
      actsGuideText: "They open directly inside voting",
    ...
    acts: {
      ...
      heroDescription:
        "Artist details now live directly inside the voting flow. Open a card during the show, check the context, then jump right back into ranking.",
      openVoteStudio: "Open vote studio",
      searchPlaceholder: "Search by artist, country, or song",
      loadError: "Unable to load the artist card layer right now.",
      roomLabel: "Room",
      currentPlace: "Current place",
    ...
    live: {
      ...
      description:
        "Open this page on a TV or projector. Published places move into the shared room standings with clear motion.",
      revealed: "Published",
      display: "Display",
      displayReady: "External screen ready",
      loadError: "Unable to load the live stage board.",
      positionRevealed: "Position published",
      waitingReveal: "Waiting for publication",
    },
    players: {
      kicker: "Room leaderboard",
      title: "Who is calling the scoreboard best",
      description:
        "This page is the dedicated standings screen for phones, laptops, and projector views. It uses the same movement graphics as the shared live results screen.",
