  ...
  const copy = useMemo(() => (
    language === "ru"
      ? {
          ...
          description: "Полный срез по комнате: кто лидирует по точным попаданиям, как участники прошли каждый этап и насколько близко были к официальным результатам.",
      ...
      : {
          ...
          title: "Season stats",
          description: "A full room view: who leads on exact hits, how each participant performed across stages, and how close they stayed to the official results.",
