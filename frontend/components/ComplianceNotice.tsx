...
export function ComplianceNotice() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 mx-auto max-w-4xl rounded-[1.4rem] border border-white/10 bg-arenaSurface/95 px-4 py-4 shadow-[0_18px_50px_rgba(0,0,0,0.35)] backdrop-blur-xl">
