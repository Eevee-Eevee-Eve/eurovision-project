  ...
  const text = useMemo(() => (
    language === "ru"
      ? {
          ...
          watchVideoHint: "Видео, чтобы быстро вспомнить номер и вайб.",
          ...
          submitText: "Когда порядок готов, сохрани его. Пока этап открыт, можно отправить новую версию.",
          ...
          saveOrderHint: "Черновик и заметки сохраняются на этом устройстве. Пока этап открыт, считается последняя отправленная версия.",
          resubmitHint: "Последняя отправленная версия уже сохранена. Пока этап открыт, можно менять порядок и отправлять заново.",
          countdownClosingSoon: "Отправка скоро закроется",
          countdownGlobal: "До закрытия отправки",
          countdownGlobalText: "После нуля новые ответы больше не принимаются.",
          countdownPersonal: "Для тебя открыто ещё",
          countdownPersonalText: "Это личное продление от хоста. У остальных этап уже закрыт.",
          ...
          savedBadge: "Заметка",
          openActHint: "Тапни по артисту, чтобы открыть описание и заметки",
        ...
        : {
          ...
          watchVideoHint: "Video to quickly recall the act and the vibe.",
          ...
          submitText: "When the order is ready, save it. While the stage is open, you can submit an updated version.",
          ...
          saveOrderHint: "Draft order and notes stay on this device. While the stage is open, the latest submitted version counts.",
          resubmitHint: "Your latest submitted version is already saved. While the stage is open, you can keep changing the order and submit again.",
          countdownClosingSoon: "Submission is closing soon",
          countdownGlobal: "Submission closes in",
          countdownGlobalText: "After zero, new submissions are no longer accepted.",
          countdownPersonal: "Open for you for",
          countdownPersonalText: "This is a personal extension from the host. Everyone else is already closed.",
          ...
          savedBadge: "Note",
          openActHint: "Tap an act to open details and notes",
          resultsLink: "Results",
