    ...
    () =>
      language === "ru"
        ? {
            ...
            title: "Статистика игроков и стран",
            intro:
            ...
            playerHint: "Здесь показаны реальные аккаунты из активных комнат. После финала у каждого игрока появятся очки, попадания и ачивки.",
            profile: "Карточка игрока",
            noStatsTitle: "Личная статистика появится после финала",
            noStatsText:
              "Сейчас мы не показываем выдуманные цифры. Когда сезон завершится, здесь будут очки, точные места, близкие попадания, лучшие этапы и полученные ачивки.",
            noPlayers: "Пока нет зарегистрированных игроков.",
            submittedStages: "Сдано этапов",
            joinedRooms: "Комнаты",
            achievementCatalog: "Каталог ачивок",
            achievementText:
              "Это список наград, которые можно заработать в сезоне. После финала сайт сам отметит полученные бейджи в карточках игроков.",
            locked: "Можно получить",
            countries: "Страны",
            countrySearch: "Найти страну",
            countryHint: "Страны можно сравнивать по участиям, победам, топ-10, последним местам, 13-м местам и средней позиции.",
            appearances: "участий",
            wins: "побед",
            top10: "топ-10",
        ...
        : {
            kicker: "Club stats",
            title: "Player and country stats",
            intro:
            ...
            playerHint: "Only real accounts from active rooms are shown here. After the final, each player gets points, hits, and achievements.",
            profile: "Player card",
            noStatsTitle: "Personal stats appear after the final",
            noStatsText:
              "We are not showing invented numbers. Once the season is completed, this card will show points, exact places, close calls, best stages, and earned achievements.",
            noPlayers: "No registered players yet.",
            submittedStages: "Submitted stages",
            joinedRooms: "Rooms",
            achievementCatalog: "Achievement catalog",
            achievementText:
              "A catalog of awards players can earn this season. After the final, earned badges will appear automatically on player cards.",
            locked: "Earnable",
            countries: "Countries",
            countrySearch: "Find country",
            countryHint: "Compare countries by appearances, wins, top-10s, last places, 13th places, and average rank.",
            appearances: "apps",
            wins: "wins",
            top10: "top-10",
            lastPlaces: "last",
